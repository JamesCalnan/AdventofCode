    ...
    Sub part1and2(inputValue As Integer)
        ...
        While 1
            ...
            ElseIf opcode = 3 Then
                instructions(If(mode(0) = 1, i + 1, instructions(i + 1))) = inputValue
                i += 2
            ElseIf opcode = 4 Then
                Console.WriteLine(instructions(If(mode(0) = 1, i + 1, instructions(i + 1))))
                i += 2
