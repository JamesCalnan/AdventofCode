...
Module Crossed_wires
    ...
    Function part1()
        Dim wire1 = getPoints("S:\AoC\Advent of Code\Advent of Code\Day 3\data1.txt")
        Dim wire2 = getPoints("S:\AoC\Advent of Code\Advent of Code\Day 3\data2.txt")
    ...
    Function part2()
        ...
        Dim closestMovement = intersections.Select(Function(p) wire1.IndexOf(p) + wire2.IndexOf(p)).OrderBy(Function(i) True).First()
